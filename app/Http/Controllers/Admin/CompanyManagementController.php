...
class CompanyManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect('/admin/insurance-company-management')->with(array('status' => 'success', 'message' => 'New Company Successfully created!'));
        } catch (\Exception $e) {
    ...
    public function show($id)
    {
        ...
        return view('admin.masjid.masjid_view')->with(
            array(
    ...
    public function update(Request $request, User $User, $id)
    {
        ...
        try {
            ...
            return redirect('/admin/insurance-company-management')->with(array('status' => 'success','message' => 'Update record successfully.'));
        } catch (\exception $e) 
        {
            return back()->with(array('status' => 'danger','message' =>  $e->getMessage()));
