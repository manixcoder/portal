		...
		<div class="card">
			<div class="card-body">				
                <div class="right-side-struct pull-right" >
				    <a href="{{ url('/user/user-management/create') }}" class="btn btn-info waves-effect waves-light clearfix add-new add-faicon"  ><i class="fa fa-plus" aria-hidden="true"></i> Add New User </a>
				</div>
...
$(function() {
    $('#dataTable').DataTable({ 
        ...
        order: [[1,'desc']],
        ajax: '{!! url("/user/user-management/user-data") !!}',
        columns: [		
    ...
    swal({
          ...
          buttonsStyling: false
              ...
              if (isConfirm.value === true) {
                  ...
                  $.ajax({
                      url:'{{ url("/user/user-management/delete") }}'+'/'+id,
                      type: 'GET',
                      success:function(){
                          ...
                          swal(
                              ...
                              'success'
                                  ...
                                  window.location.href = '{{ url("/user/user-management") }}';
                        });
                    }
                });  
            }
