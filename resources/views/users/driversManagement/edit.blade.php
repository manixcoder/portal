...
@section('pageTitle','Update Driver')
@section('content')
@section('pageCss')
<style>
</style>
...
<div class="col-lg-12">
		<div class="card card-outline-info">
			...
			<div class="card-body">
				...
				<form class="edit-form" method="POST" action='{{ url("/user/driver-management/".$userId."/update") }}' enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="form-body">
						<div class="row p-t-20">
							<div class="col-md-6">
								<div class="form-group  @error('first_name') has-danger @enderror ">
									...
									<input
										...
										value="{{ old('first_name',(isset($userData['value']) && !empty($userData['value']['first_name'])) ? $userData['value']['first_name'] : '' ) }}"
                                    />
									@error('first_name')
							...
							<div class="col-md-6">
								<div class="form-group  @error('middle_name') has-danger @enderror ">
									...
									<input
										...
										value="{{ old('middle_name',(isset($userData['value']) && !empty($userData['value']['middle_name'])) ? $userData['value']['middle_name'] : '' ) }}"
                                    />
									@error('middle_name')
                            ...
                            <div class="col-md-6">
								<div class="form-group  @error('last_name') has-danger @enderror ">
									...
									<input
										...
										value="{{ old('last_name',(isset($userData['value']) && !empty($userData['value']['last_name'])) ? $userData['value']['last_name'] : '' ) }}"
                                    />
									@error('lastName')
							...
							<div class="col-md-6">
								<div class="form-group  @error('email') has-danger @enderror ">
									...
									<input
                                        ...
                                        value="{{ old('email',(isset($userData['value']) && !empty($userData['value']['email'])) ? $userData['value']['email'] : '' ) }}"
                                    />
									@error('email')
							...
							<div class="col-md-6">
								<div class="form-group  @error('phone') has-danger @enderror ">
									...
									<input
										...
										name="phone"
										placeholder="phone"
										value="{{ old('phone',(isset($userData['value']) && !empty($userData['value']['phone'])) ? $userData['value']['phone'] : '' ) }}"
                                    />
									@error('phone')
							...
							<div class="col-md-6">
								<div class="form-group  @error('address') has-danger @enderror ">
									...
									<textarea
										...
										id="address"
										placeholder="Address"
										name="address">{{ old('address',(isset($userData['value']) && !empty($userData['value']['location']['address'])) ? $userData['value']['location']['address'] : '' ) }}</textarea>
										@error('address')
							...
							<div class="col-md-6">
								<div class="form-group @error('addressCountry') has-danger @enderror">
									...
									<select 
									class="form-control @error('addressCountry') form-control-danger @enderror" 
									id="addressCountry" 
									placeholder="addressCountry" 
									name="addressCountry" 
									onChange="getCountyLicenseClass(this);">
							...
							<div class="col-md-6">
								<div class="form-group  @error('driver_license_number') has-danger @enderror ">
									...
									<input
										...
										value="{{ old('driver_license_number',(isset($userData['value']) && !empty($userData['value']['driver_license_number'])) ? $userData['value']['driver_license_number'] : '' ) }}"
                                    />
							...
							<div class="col-md-6">
								<div class="form-group  @error('driver_license_valid_till') has-danger @enderror ">
									...
									<input
                                        ...
                                        value="{{ old('driver_license_valid_till',(isset($userData['value']) && !empty($userData['value']['driver_license_valid_till'])) ? $userData['value']['driver_license_valid_till'] : '' ) }}"
                                        data-dtp="dtp_MHyIp"
                                    />
							...
							<div class="col-md-6">
								<div class="form-group  @error('personnel_number') has-danger @enderror ">
									...
									<input
                                        ...
                                        value="{{ old('personnel_number',(isset($userData['value']) && !empty($userData['value']['personnel_number'])) ? $userData['value']['personnel_number'] : '' ) }}"
                                    />
