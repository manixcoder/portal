	...
	<div class="col-lg-12">
		<div class="card card-outline-info">
			...
			<div class="card-body">
					...
					<form class="edit-form" method="POST" action="{{ url('/company/user-management/save-user') }}" enctype="multipart/form-data">
						{{ csrf_field() }}
							...
							<div class="row p-t-20">
								...
								<div class="col-md-12">
									<div class="form-group  @error('info') has-danger @enderror ">
										...
										<textarea
											class="form-control   @error('notes') form-control-danger @enderror  "
											id="info"
