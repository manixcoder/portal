			...
			<div class="card-body">
				...
				<div class="table-responsive m-t-40">
					...
					<div class="right-side-struct">
				 	   <a href="{{ url('/company/email-management/create') }}" class="btn btn-info waves-effect waves-light clearfix add-new add-faicon"  ><i class="fa fa-plus" aria-hidden="true"></i> Add New Template</a>
					</div>
...
$(function() {
    $('#dataTable').DataTable({
        ...
        order: [[1,'Asc']],
        ajax: '{!! url("/company/email-management/template-data") !!}',
        columns: [
    ...
    swal({
          ...
          buttonsStyling: false
            ...
            if (isConfirm.value === true) {
                ...
                $.ajax({
                    url:'{{ url("/company/email-management/delete") }}'+'/'+id,
                    type: 'GET',
                    success:function(){
                        ...
                        swal(
                            ...
                            window.location.href = '{{ url("/company/email-management") }}';
                        });
                    }
                });  
            }
