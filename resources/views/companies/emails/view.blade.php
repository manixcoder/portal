	...
	<div class="col-lg-12">
		<div class="card card-outline-info">
			<div class="card-header">
				...
				<a href ="<?php echo  env('APP_URL');?>company/email-management/<?php echo Crypt::encrypt($pageData->id); ?>/edit"  style="float:right;color:#fff;margin-top: -25px;" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Template</a>
			</div>
			<div class="card-body">
