			...
			<div class="card-body">
				...
				<div class="table-responsive m-t-40">
					...
					<div class="right-side-struct">
				 	   <a href="{{ url('/company/page-management/create') }}" class="btn btn-info waves-effect waves-light clearfix add-new add-faicon"  ><i class="fa fa-plus" aria-hidden="true"></i> Add New Page</a>
					</div>
