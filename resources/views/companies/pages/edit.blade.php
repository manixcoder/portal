	...
	<div class="col-lg-12">
		<div class="card card-outline-info">
			<div class="card-header">
				<h4 class="m-b-0 text-white"> <i class="fa fa-plus" aria-hidden="true"></i> Edit Page : {{ $pageData->name  }}</h4>
			</div>
			<div class="card-body">
					...
					<form class="edit-form" method="POST" action="{{ url('/company/page-management/'.Crypt::encrypt($pageData->id).'/update') }}" enctype="multipart/form-data">
						{{ csrf_field() }}
							...
							<div class="row p-t-20">
								...
								<div class="col-md-4">
									<div class="form-group  @error('page_slug') has-danger @enderror ">
										...
										<input 
											type="text"
											class="form-control @error('page_slug') form-control-danger @enderror" 
											id="page_slug" 
											name="page_slug" 
											value="{{ old('page_slug',(isset($pageData) && !empty($pageData->page_slug)) ? $pageData->page_slug : '' ) }}"
											disabled
										/>
										@error('page_slug')
