    ...
    <script type="text/javascript">
        $(function() {
            ...
            */
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! url( "/company/masjid-compain/compain-data") !!}/' + '{{ $masjidData->id }}',
                columns: [{
                        data: 'compainLogo',
                        name: 'compainLogo',
                        orderable: false,
        ...
        */
        $(document).on('submit', '#addCompain', function() {
            ...
            $.ajax({
                'url': "{!!  url( '/company/insurance-company-management/save-compain') !!}",
                'method': 'post',
                'dataType': 'json',
                'data': formData,
                processData: false,
        ...
        */
        $(document).on('submit', '#editCompain', function() {
            ...
            var formData = new FormData(FormId);
            $.ajax({
                'url': "{!!  url( '/company/masjid-compain/update') !!}",
                'method': 'post',
                'dataType': 'json',
                'data': formData,
                processData: false,
        ...
        $(document).on('click', 'a.editCompain', function() {
            ...
            $.ajax({
                'url': "{!!  url( '/company/masjid-compain/') !!}/" + capId + '/edit',
                'method': 'get',
                'dataType': 'json',
        ...
        $(document).on('click', '.delete', function() {
            ...
            swal({
                ...
                if (isConfirm.value === true) {
                    $('#dataTable_processing').show();
                    $.ajax({
                        url: '{{ url("/company/masjid-compain/delete") }}' + '/' + id,
                        type: 'GET',
                        success: function() {
                            $('#dataTable_processing').hide();
                            swal(
